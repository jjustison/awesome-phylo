...
* [PhyloFusion](https://github.com/husonlab/splitstree6) - A method in SplitsTree that takes a set of input trees and constructs a tree-child network. The output network then displays all input trees.
